...
WebUI.click(findTestObject('Page_UserProfileTMDB/OverviewAction/overviewToFavoriteToMovieListButton'))

WebUI.click(findTestObject('Object Repository/Page_MyFavoritesTMDB/removeButton'))
